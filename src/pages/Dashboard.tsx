          ...
          <main className="flex-1 p-6 overflow-auto">
            <div className="max-w-7xl mx-auto space-y-6">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <MetricCard label="Focus Score" value={metrics?.focus_score ?? 75} icon={Brain} trend={5} color="primary" />
                <MetricCard label="Energy Level" value={metrics?.energy_level ?? 80} icon={Battery} trend={-2} color="success" />
                <MetricCard label="Productivity" value={metrics?.productivity ?? 70} icon={TrendingUp} trend={8} color="warning" />
                <MetricCard label="Stress Level" value={metrics?.stress_level ?? 30} icon={Zap} trend={-10} color="destructive" />
              </div>
